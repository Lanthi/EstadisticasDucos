...
Public Class Form1
    ...
    Private Sub Actualizar()
        ...
        Select Case Hour(Now)
            Case 0 : If lblBalanceHora00.Text <> 0 Then lblHoraDiferencia00.Text = CDec(lblBalanceHora00.Text) - CDec(txtbalance.Text)
            Case 1 : If lblBalanceHora01.Text <> 0 Then lblHoraDiferencia01.Text = CDec(lblBalanceHora01.Text) - CDec(txtbalance.Text)
            Case 2 : If lblBalanceHora02.Text <> 0 Then lblHoraDiferencia02.Text = CDec(lblBalanceHora02.Text) - CDec(txtbalance.Text)
            Case 3 : If lblBalanceHora03.Text <> 0 Then lblHoraDiferencia03.Text = CDec(lblBalanceHora03.Text) - CDec(txtbalance.Text)
            Case 4 : If lblBalanceHora04.Text <> 0 Then lblHoraDiferencia04.Text = CDec(lblBalanceHora04.Text) - CDec(txtbalance.Text)
            Case 5 : If lblBalanceHora05.Text <> 0 Then lblHoraDiferencia05.Text = CDec(lblBalanceHora05.Text) - CDec(txtbalance.Text)
            Case 6 : If lblBalanceHora06.Text <> 0 Then lblHoraDiferencia06.Text = CDec(lblBalanceHora06.Text) - CDec(txtbalance.Text)
            Case 7 : If lblBalanceHora07.Text <> 0 Then lblHoraDiferencia07.Text = CDec(lblBalanceHora07.Text) - CDec(txtbalance.Text)
            Case 8 : If lblBalanceHora08.Text <> 0 Then lblHoraDiferencia08.Text = CDec(lblBalanceHora08.Text) - CDec(txtbalance.Text)
            Case 9 : If lblBalanceHora09.Text <> 0 Then lblHoraDiferencia09.Text = CDec(lblBalanceHora09.Text) - CDec(txtbalance.Text)
            Case 10 : If lblBalanceHora10.Text <> 0 Then lblHoraDiferencia10.Text = CDec(lblBalanceHora10.Text) - CDec(txtbalance.Text)
            Case 11 : If lblBalanceHora11.Text <> 0 Then lblHoraDiferencia11.Text = CDec(lblBalanceHora11.Text) - CDec(txtbalance.Text)
            Case 12 : If lblBalanceHora12.Text <> 0 Then lblHoraDiferencia12.Text = CDec(lblBalanceHora12.Text) - CDec(txtbalance.Text)
            Case 13 : If lblBalanceHora13.Text <> 0 Then lblHoraDiferencia13.Text = CDec(lblBalanceHora13.Text) - CDec(txtbalance.Text)
            Case 14 : If lblBalanceHora14.Text <> 0 Then lblHoraDiferencia14.Text = CDec(lblBalanceHora14.Text) - CDec(txtbalance.Text)
            Case 15 : If lblBalanceHora15.Text <> 0 Then lblHoraDiferencia15.Text = CDec(lblBalanceHora15.Text) - CDec(txtbalance.Text)
            Case 16 : If lblBalanceHora16.Text <> 0 Then lblHoraDiferencia16.Text = CDec(lblBalanceHora16.Text) - CDec(txtbalance.Text)
            Case 17 : If lblBalanceHora17.Text <> 0 Then lblHoraDiferencia17.Text = CDec(lblBalanceHora17.Text) - CDec(txtbalance.Text)
            Case 18 : If lblBalanceHora18.Text <> 0 Then lblHoraDiferencia18.Text = CDec(lblBalanceHora18.Text) - CDec(txtbalance.Text)
            Case 19 : If lblBalanceHora19.Text <> 0 Then lblHoraDiferencia19.Text = CDec(lblBalanceHora19.Text) - CDec(txtbalance.Text)
            Case 20 : If lblBalanceHora20.Text <> 0 Then lblHoraDiferencia20.Text = CDec(lblBalanceHora20.Text) - CDec(txtbalance.Text)
            Case 21 : If lblBalanceHora21.Text <> 0 Then lblHoraDiferencia21.Text = CDec(lblBalanceHora21.Text) - CDec(txtbalance.Text)
            Case 22 : If lblBalanceHora22.Text <> 0 Then lblHoraDiferencia22.Text = CDec(lblBalanceHora22.Text) - CDec(txtbalance.Text)
            Case 23 : If lblBalanceHora23.Text <> 0 Then lblHoraDiferencia23.Text = CDec(lblBalanceHora23.Text) - CDec(txtbalance.Text)
        End Select
        Select Case DateAndTime.Day(Now)
            Case 1 : If lblMesBalance01.Text <> 0 Then lblMesDifencia01.Text = CDec(lblMesBalance01.Text) - CDec(txtbalance.Text)
            Case 2 : If lblMesBalance02.Text <> 0 Then lblMesDifencia02.Text = CDec(lblMesBalance02.Text) - CDec(txtbalance.Text)
            Case 3 : If lblMesBalance03.Text <> 0 Then lblMesDifencia03.Text = CDec(lblMesBalance03.Text) - CDec(txtbalance.Text)
            Case 4 : If lblMesBalance04.Text <> 0 Then lblMesDifencia04.Text = CDec(lblMesBalance04.Text) - CDec(txtbalance.Text)
            Case 5 : If lblMesBalance05.Text <> 0 Then lblMesDifencia05.Text = CDec(lblMesBalance05.Text) - CDec(txtbalance.Text)
            Case 6 : If lblMesBalance06.Text <> 0 Then lblMesDifencia06.Text = CDec(lblMesBalance06.Text) - CDec(txtbalance.Text)
            Case 7 : If lblMesBalance07.Text <> 0 Then lblMesDifencia07.Text = CDec(lblMesBalance07.Text) - CDec(txtbalance.Text)
            Case 8 : If lblMesBalance08.Text <> 0 Then lblMesDifencia08.Text = CDec(lblMesBalance08.Text) - CDec(txtbalance.Text)
            Case 9 : If lblMesBalance09.Text <> 0 Then lblMesDifencia09.Text = CDec(lblMesBalance09.Text) - CDec(txtbalance.Text)
            Case 10 : If lblMesBalance10.Text <> 0 Then lblMesDifencia10.Text = CDec(lblMesBalance10.Text) - CDec(txtbalance.Text)
            Case 11 : If lblMesBalance11.Text <> 0 Then lblMesDifencia11.Text = CDec(lblMesBalance11.Text) - CDec(txtbalance.Text)
            Case 12 : If lblMesBalance12.Text <> 0 Then lblMesDifencia12.Text = CDec(lblMesBalance12.Text) - CDec(txtbalance.Text)
            Case 13 : If lblMesBalance13.Text <> 0 Then lblMesDifencia13.Text = CDec(lblMesBalance13.Text) - CDec(txtbalance.Text)
            Case 14 : If lblMesBalance14.Text <> 0 Then lblMesDifencia14.Text = CDec(lblMesBalance14.Text) - CDec(txtbalance.Text)
            Case 15 : If lblMesBalance15.Text <> 0 Then lblMesDifencia15.Text = CDec(lblMesBalance15.Text) - CDec(txtbalance.Text)
            Case 16 : If lblMesBalance16.Text <> 0 Then lblMesDifencia16.Text = CDec(lblMesBalance16.Text) - CDec(txtbalance.Text)
            Case 17 : If lblMesBalance17.Text <> 0 Then lblMesDifencia17.Text = CDec(lblMesBalance17.Text) - CDec(txtbalance.Text)
            Case 18 : If lblMesBalance18.Text <> 0 Then lblMesDifencia18.Text = CDec(lblMesBalance18.Text) - CDec(txtbalance.Text)
            Case 19 : If lblMesBalance19.Text <> 0 Then lblMesDifencia19.Text = CDec(lblMesBalance19.Text) - CDec(txtbalance.Text)
            Case 20 : If lblMesBalance20.Text <> 0 Then lblMesDifencia20.Text = CDec(lblMesBalance20.Text) - CDec(txtbalance.Text)
            Case 21 : If lblMesBalance21.Text <> 0 Then lblMesDifencia21.Text = CDec(lblMesBalance21.Text) - CDec(txtbalance.Text)
            Case 22 : If lblMesBalance22.Text <> 0 Then lblMesDifencia22.Text = CDec(lblMesBalance22.Text) - CDec(txtbalance.Text)
            Case 23 : If lblMesBalance23.Text <> 0 Then lblMesDifencia23.Text = CDec(lblMesBalance23.Text) - CDec(txtbalance.Text)
            Case 24 : If lblMesBalance24.Text <> 0 Then lblMesDifencia24.Text = CDec(lblMesBalance24.Text) - CDec(txtbalance.Text)
            Case 25 : If lblMesBalance25.Text <> 0 Then lblMesDifencia25.Text = CDec(lblMesBalance25.Text) - CDec(txtbalance.Text)
            Case 26 : If lblMesBalance26.Text <> 0 Then lblMesDifencia26.Text = CDec(lblMesBalance26.Text) - CDec(txtbalance.Text)
            Case 27 : If lblMesBalance27.Text <> 0 Then lblMesDifencia27.Text = CDec(lblMesBalance27.Text) - CDec(txtbalance.Text)
            Case 28 : If lblMesBalance28.Text <> 0 Then lblMesDifencia28.Text = CDec(lblMesBalance28.Text) - CDec(txtbalance.Text)
            Case 29 : If lblMesBalance29.Text <> 0 Then lblMesDifencia29.Text = CDec(lblMesBalance29.Text) - CDec(txtbalance.Text)
            Case 30 : If lblMesBalance30.Text <> 0 Then lblMesDifencia30.Text = CDec(lblMesBalance30.Text) - CDec(txtbalance.Text)
            Case 31 : If lblMesBalance31.Text <> 0 Then lblMesDifencia31.Text = CDec(lblMesBalance01.Text) - CDec(txtbalance.Text)
        End Select
        lblTotalHora.Text = 0
        lblTotalHora.Text += CDec(lblHoraDiferencia00.Text)
        lblTotalHora.Text += CDec(lblHoraDiferencia01.Text)
    ...
    Private Sub Añadir()
        ...
        If lblBalanceHora22.Text <> 0 And lblBalanceHora21.Text <> 0 Then lblHoraDiferencia21.Text = CDec(lblBalanceHora22.Text) - CDec(lblBalanceHora21.Text)
        If lblBalanceHora23.Text <> 0 And lblBalanceHora22.Text <> 0 Then lblHoraDiferencia22.Text = CDec(lblBalanceHora23.Text) - CDec(lblBalanceHora22.Text)
        lblHoraDiferencia23.Text = CDec(lblBalanceHora23.Text) - CDec(txtbalance.Text)
        ...
        If lblMesBalance30.Text <> 0 And lblMesBalance29.Text <> 0 Then lblMesDifencia29.Text = CDec(lblMesBalance30.Text) - CDec(lblMesBalance29.Text)
        If lblMesBalance31.Text <> 0 And lblMesBalance30.Text <> 0 Then lblMesDifencia30.Text = CDec(lblMesBalance31.Text) - CDec(lblMesBalance30.Text)
        lblMesDifencia31.Text = CDec(lblMesBalance31.Text) - CDec(txtbalance.Text)
        lblTotalHora.Text = 0
        lblTotalHora.Text += CDec(lblHoraDiferencia00.Text)
        lblTotalHora.Text += CDec(lblHoraDiferencia01.Text)
        lblTotalHora.Text += CDec(lblHoraDiferencia02.Text)
